...
public class LoggingCalculatorAspect {
    ...
    @Before("execution(public * com.example.springaoplivelecture230312.calculatoraop.CalculatorAopImpl.*(..))")
    public void logBefore(JoinPoint joinPoint) {
        log.info("Before " + joinPoint.getSignature().getName() + " method");
        log.info("Start Operate");
    }

    @AfterReturning(value = "execution(public * com.example.springaoplivelecture230312.calculatoraop.CalculatorAopImpl.*(..))", returning = "result")
